...
namespace FoodOrderingAPI.Migrations
{
    ...
    [Migration("20250816082105_AddedUserAndUserRoleDbset")]
    partial class AddedUserAndUserRoleDbset
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FoodOrderingAPI.Models.Order", b =>
                {
                    b.HasOne("FoodOrderingAPI.Models.Invoice", "Invoice")
                        .WithOne("Order")
                        .HasForeignKey("FoodOrderingAPI.Models.Order", "InvoiceId")
            ...
            modelBuilder.Entity("FoodOrderingAPI.Models.OrderTracking", b =>
                {
                    ...
                    b.HasOne("FoodOrderingAPI.Models.Order", null)
                        .WithMany("OrderTrackings")
